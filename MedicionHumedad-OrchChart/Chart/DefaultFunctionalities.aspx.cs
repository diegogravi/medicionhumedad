...
namespace WebSampleBrowser.Chart
{
    public partial class DefaultFunctionalities : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            data.Add(new LineChartData("2021-11-22 02:26:02",  36));
            data.Add(new LineChartData("2021-11-22 03:26:02", 32));
            data.Add(new LineChartData("2021-11-22 04:26:02", 34));
            data.Add(new LineChartData("2021-11-22 05:26:02", 41));
            data.Add(new LineChartData("2021-11-22 06:26:02", 42));
            data.Add(new LineChartData("2021-11-22 07:26:02",  42));
            data.Add(new LineChartData("Proximo",  44));
