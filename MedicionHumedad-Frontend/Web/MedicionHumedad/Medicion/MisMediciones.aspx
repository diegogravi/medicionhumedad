<%@ Page Title="Mis Reservas" Language="C#" MasterPageFile="~/Usuario.Master" AutoEventWireup="true" CodeBehind="MisMediciones.aspx.cs" Inherits="MedicionHumedad._MisReservas" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <style type='text/css'>
        body { background-image: url(../images/medicion.jpg); }
    </style>
