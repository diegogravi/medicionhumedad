                ...
                switch (filterOption)
                {
                    ...
                    case FilterOptions.IsEqualTo:
                        ...
                        else
                        {
                            ...
                            else if ((filterColumn.PropertyType == typeof(Nullable<Boolean>)) && Boolean.TryParse(filterValue, out boolValue))
                            {
                                data = data.Where(x => Convert.ToBoolean(filterColumn.GetValue(x, null)) == boolValue).ToList();
                                break;
                            }
                            else
                            {
