<%@ Page Title="Medicion de humedad"  Async="true"   Language="C#" MetaDescription="Mediciones" MasterPageFile="~/Samplebrowser.Master" AutoEventWireup="true" CodeBehind="HistorialMediciones.aspx.cs" Inherits="WebSampleBrowser.Chart.HistorialMediciones" %>
  ...
  <div id="container">
      ...
      <table style="margin-top:20px;">
          <tr class="spaceUnder">
           ...
           <tr class="spaceUnder">
              <td>
                  Cantidad de lecturas: <asp:TextBox ID="txtLecturas" runat="server" Text="5" Width="80px"></asp:TextBox>
              </td>
              <td>
                  Plantacion: <asp:dropdownlist runat="server" id="ddlPlantacion" AutoPostBack="false"> 
                                 <asp:listitem text="Tampa, FL" value="1" Selected="True"></asp:listitem>
                                 <asp:listitem text="Plant City, FL" value="2"></asp:listitem>
                            </asp:dropdownlist>
              </td>
              <td>
          ...
          <tr class="spaceUnder">
              <td colspan="4" style="text-align:center">
                  <asp:Button ID="btnLoadData" runat="server" Text="Cargar Mediciones" OnClick="btnLoadData_Click" BackColor="CadetBlue" ForeColor="White"/>
              </td>
          </tr>
      </table>
    </div>
