...
namespace MedicionHumedad.Api
{
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped(typeof(IFrutoServiceAsync), typeof(FrutoServiceAsync));
            ...
            services.AddScoped(typeof(IOrchestratorServiceAsync), typeof(OrchestratorServiceAsync));
